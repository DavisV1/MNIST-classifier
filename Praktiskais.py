...
learning_rate = 0.01  # HyperParameter Optimaizerim
momentum = 0.5  # HyperParameter Optimaizerim
log_interval = 10
...
# Ar backward() savāc jaunu setu gradientu kuru izmanto tīklā ar optimizer.step ()
...
# Neironu tīkla modeļiem un optimaizeriem ir iespēja saglabāt un ielādēt iekšējo stāvokli ar .state_dirct()
# Ar to var turpināt trenēt iepriekš saglabāto dict ja nepieciešams ar .load_state_dict(state_dict)
# Test loop kurā summē loss un seko līdz pareizi atpazītajiem cipariem
def test():
    network.eval()
    test_loss = 0
    correct = 0
